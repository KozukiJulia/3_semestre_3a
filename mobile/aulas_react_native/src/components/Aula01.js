...
export default function Aula01() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titulo}>Open up App.js to start working on your app!</Text>
      <Text style={styles.titulo}>Hello, World!</Text>
      <Text style={styles.titulo}>Olá, esse é o meu primeiro app!</Text>

      <View style={styles.fullWidthBox}>
        <Text style={styles.leftText}>Texto 1 </Text>
        <Text style={styles.rightText}>Texto 2 </Text>
        <Text style={styles.centerText}>Texto 3 </Text>
      </View>

      <StatusBar style="auto" /> {/* Componente para configurar a barra de status, com estilo automático */}
    </View>
  );
}
